...
class ERService:
  ...
  def check_load(self, hospital_id: int) -> str
      #looks up current load at hospital corresponding to hospital_id 
      #returns string of expected wait time at hospital
      pass

  def cancel_booking(self, booking_id: int) -> None
      #deletes Booking from ERQueue and notifies user of successfull cancellation on success
      pass
